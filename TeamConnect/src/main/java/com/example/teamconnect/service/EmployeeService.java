...
public interface EmployeeService {
    ...
    ResponseEntity<ResponseClass> registeration(EmployeeDto employeeDto,HttpServletRequest request) throws DataAlreadyExistsException, LoginFailedException;  // by default the access specifier is public abstract for interface
